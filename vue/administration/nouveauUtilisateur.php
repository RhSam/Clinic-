   ...
   <div class="col-xs-10 col-xs-push-1 row 2">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <form id="nouveauUtilisateur" action="../../traitements/nouveauUtilisateurPost.php" method="post" class="form nouveauUtilisateur">
          ...
          <div class="col-xs-6">
           ...
           <input type="text" class="input-lg form-control nom" name="nom" id="nom" required="required" placeholder="nom de l'utilisateur" spellcheck="false" maxlength="25" autocomplete="off" tabindex="1"/>
          </div>
          
          <div class="col-xs-6">
           <label class="label label-default">Prénoms</label>
           <input type="text" class="input-lg form-control prenom" name="prenoms" id="prenoms" required="required" placeholder="prénoms de l'utilisateur" spellcheck="false" maxlength="25" autocomplete="off" tabindex="2"/>
          </div>
           <br />
           <br />
           <br />
          ...
          <div class="col-xs-6">
           ...
           <input type="text" class="input-lg form-control" name="login" id="login" required="required" placeholder="nom d'utilisateur" spellcheck="false" maxlength="25" autocomplete="off" tabindex="3"/>
          </div>
          ...
          <label class="label label-default">Password</label>
           ...
           <input type="password" class="input-lg form-control" name="password" id="password" placeholder="mot de passe" autocomplete="off" required="required" spellcheck="false" maxlength="25" tabindex="4" />
          ...
          <div class="col-xs-12">
           ...
           <input type="text" class="input-lg form-control" name="indice" id="indice" required="required" placeholder="indice pour retrouver le mot de passe" spellcheck="false" maxlength="50" autocomplete="off" tabindex="5"/>
          </div>
          ...
          <div class="col-xs-12">
           ...
           <div class="col-xs-6 text-right">
            <button data-toggle="modal" data-backdrop="false" href="#newUser" type="button" class="btn btn-success btn-lg">Valider</button>
           </div>
          </div>
				   ...
				   <form class="form">
					 <h3>
					  ...
					  <div class="col-xs-12 text-center">
					   <button type="submit" form="nouveauUtilisateur" class="btn btn-info">OK!</button>
					  </div>
