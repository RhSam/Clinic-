...
$total=count($reponseCalcul->fetchAll());
         ...
         <div class="panel-body">
           <form method="get" action="hospitalisationPatients.php"> 
		  ...
		  $donnees2=$req2->fetch();
                          ...
                          echo '<tr>
                                 ...
                                 <td height="83">
                                    ...
                                    <button class="btn btn-default btn-block btn-lg"> <a href="hospitalisationUn.php?Nom='.$donnees['Nom'].'&Prenoms='.$donnees['Prenoms'].'&Per_Id='.$donnees['Id'].'">Hospitalisations</a></button>
									 </div>
