...
<?php //sécurité contre l'accès à la page par l'url directement
 if ($_SESSION['clearance']<3) //les users  
 {
...
<div class="col-xs-2 bread">
 ...
 <ul  class="list-inline">
   ...
   <li class="child" style="border:2px dotted rgba(204,255,255,1);
	border-radius:4px 4px 4px 4px;" id="current">►Informations</li>
 ...
 $donneesRequete1=$requete1->fetch();
       ...
       <div class="panel-heading">
        ...
        <div class="entete">
        Affichage et modification des informations du patient
       ...
       <div class="panel-body" style="height:486px;overflow:auto;">
        ...
        <form id="formulaireModificationPatient" class="form" method="post" action="../traitements/modifierPatientPatientPost.php" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="<?php echo $_GET['IdPatient']?>" />
         ...
         <div class="col-xs-3">
	      ...
	      while($donnees=$req->fetch())
		  {
           ...
           <div class="col-xs-2">
            ...
            <select name="groupeSanguin" id="groupeSanguin" class="form-control input-lg groupeSanguin" tabindex="10">
             <option value="<?php $donneesRequete1['GroupeSanguin']?>"> <?php if($donneesRequete1['GroupeSanguin']==""){echo 'Indéterminé';} else{ echo $donneesRequete1['GroupeSanguin'];}?></option>
          ...
          <div class="col-xs-12">
           ...
           <br />  
            ...
            <div class="col-xs-12">
            <label class="label label-default" for="allergies">Allergies</label>
            <input class="form-control input-lg" type="text" name="allergies" id="allergies" tabindex="15" placeholder="Allergènes du patient" autocomplete="on" value="<?php echo $donneesRequete1['Allergies']?>"/>
           </div> <!--antecedentsPersonnels --> 
           <br />
           <br />
           <br />
           <br />  
            ...
            <div class="col-xs-12">
            <label class="label label-default" for="antecedentsPersonnels"> Antécédents Personnels</label>
            <input class="form-control input-lg adresse" type="text" name="antecedentsPersonnels" id="antecedentsPersonnels" tabindex="16" placeholder="Antécédents personnels du patient" autocomplete="on" value="<?php echo $donneesRequete1['AntecedentsPersonnels']?>"/>
           </div> <!--antecedentsPersonnels -->  
           ...
           <div class="col-xs-12">
            <label class="label label-default" for="antecedentsFamiliaux"> Antécédents Familiaux</label>
            <input class="form-control input-lg adresse" type="text" name="antecedentsFamiliaux" id="antecedentsFamiliaux" tabindex="17" placeholder="Antécédents familiaux du patient" autocomplete="on" value="<?php echo $donneesRequete1['AntecedentsFamiliaux']?>"/>
           </div> <!--antecedentsFamiliaux -->  
           ...
           <div class="col-xs-12">
            <label class="label label-default" for="vaccins"> Vaccins</label>
            <input class="form-control input-lg adresse" type="text" name="vaccins" id="vaccins" tabindex="18" placeholder="Vaccins reçus par le patient" autocomplete="on" value="<?php echo $donneesRequete1['Vaccins']?>"/>
           </div> <!--antecedentsFamiliaux -->  
           ...
           <div class="col-xs-6">
            ...
            <input class="form-control input-lg nom" type="text" name="nomPap" id="nomPap" required="required" spellcheck="false" tabindex="19" placeholder="Nom de la personne à prévenir" maxlength="50" autocomplete="on" value="<?php echo $donneesRequete1['PapNom']?>"/>
           </div><!--nomPap -->
           
           
           <div class="col-xs-6">
          <label class="label label-default" for="prenomsPap">* Prénoms</label>
          <input class="form-control input-lg prenomPap" type="text" name="prenomsPap" id="prenomsPap" required="required" spellcheck="false" tabindex="20" placeholder="Prénoms de la personne à prévenir" maxlength="50" autocomplete="on" value="<?php echo $donneesRequete1['PapPrenoms']?>"/>
         </div><!--prénomsPap -->
          ...
          <div class="col-xs-6">
            ...
            <input class="form-control input-lg telephone" type="tel" name="telephoneDomicilePap" id="telephoneDomicilePap" spellcheck="false" tabindex="21" placeholder="Numéro de téléphone au domicile de la personne à prévenir" pattern="^(([0-9]{5})|(\+[0-9]{3}))?([-. ]?[0-9]{2}){4}$" autocomplete="on" required="required" value="<?php echo $donneesRequete1['PapTelephoneDomicile']?>"/>
          </div> <!--telephone 1 Pap -->
           
           
          <div class="col-xs-6">
            <label class="label label-default" for="telephoneProfessionnelPap">Téléphone</label>
            <input class="form-control input-lg telephone" type="tel" name="telephoneProfessionnelPap" id="telephoneProfessionnelPap" spellcheck="false" tabindex="22" placeholder="Numéro de téléphone professionnel de la personne à prévenir" pattern="^(([0-9]{5})|(\+[0-9]{3}))?([-. ]?[0-9]{2}){4}$" autocomplete="on" value="<?php echo $donneesRequete1['PapTelephoneProfessionnel']?>"/>
          </div> <!--telephone 2 Pap-->
         ...
         <div class="col-xs-12">
            ...
            <input class="form-control input-lg email" type="email" name="emailPap" id="emailPap" tabindex="23" placeholder="Adresse électronique de la personne à prévenir" maxlength="50" autocomplete="on"  value="<?php echo $donneesRequete1['PapEmail']?>"/>
         </div> <!--E-Mail -->   
 ...
 <div class="col-xs-2" style="position:fixed; margin-top:31%;">
  ...
  <div class="modal fade col-xs-12 col-xs-offset-1" id="confirmation">
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <div class="modal-header text-right">
            <a href="modifierPatientPatient.php?&amp;IdPatient=<?php echo $_GET['IdPatient'];?>"><button type="button" class="btn btn-danger">x</button></a>
         </div>
				 ...
				 <div class="panel panel-body text-center">
				   ...
				   <form class="form">
					 ...
					 { 
					  ...
					  <div class="col-xs-12 text-center">
					   <a href="modifierPatientPatient.php?&amp;IdPatient=<?php echo $_GET['IdPatient'];?>"><button type="button" class="btn btn-info">Fermer</button></a>
					  </div>
