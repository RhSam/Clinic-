...
<div class="col-xs-2 bread">
 <ul class="list-inline">
   ...
   <li class="grandchild" style="border:2px dotted rgba(204,255,255,1);
	border-radius:4px 4px 4px 4px;">»Produits</li>
...
$reponse=$bdd->prepare('SELECT * FROM PRODUIT order by NomProduit'); 
$reponse->execute();

$reponseCalcul=$bdd->prepare('SELECT * FROM PRODUIT'); 
$reponseCalcul->execute();
$total=count($reponseCalcul->fetchAll());
       ?>
       <div class="panel-heading entete" style="padding-left:8%;">
        <h4><span class="badge" id="chiffre"><?php echo $total ?></span>Produits enregistrés
          <div class="pull-right"><button class="btn btn-success" data-toggle="modal" href="#enregProduit" data-backdrop="false">Nouveau</button></div></h4>
         
       </div>
  
       <?php
	    include('corpsPanneauListeProduits.php'); //on inclut le corps du panneau
       ?>
...
<!--le modal d'enregistrement de chambre-->
  <div class="modal fade col-xs-12 col-xs-offset-1" id="enregProduit">
         ...
         <div class="modal-body">
			   ...
			   <div class="panel panel-default">
				 ...
				 <div class="panel panel-body">
					   ...
					   <form action="../traitements/nouveauProduitPost.php" method="post" id="formEnregProduit">
                       <div class="col-xs-12">
                        <label class="label label-default" for="produit">
                         Nom
                        </label>
                        <input class="form-control input-lg nom" type="text" name="produit" id="produit" spellcheck="false" autocomplete="off" placeholder="Nom du produit" required="required" maxlength="50"/>
                        </div>
                        ...
                        <div class="col-xs-6">
                        <label class="label label-default" for="format">
                         Format
                        </label>
                        <input class="form-control input-lg nom" type="text" name="format" id="format" spellcheck="true" autocomplete="on" placeholder="Format du produit" required="required" maxlength="25"/>
                        </div>
                        
                        <div class="col-xs-6">
                        <label class="label label-default" for="dosage">
                         Dosage
                        </label>
                        <input class="form-control input-lg nom" type="text" name="dosage" id="dosage" spellcheck="false" autocomplete="off" placeholder="Dosage du produit" maxlength="25"/>
                        </div>
...
<!--le modal de confirmation de l'enreg de la chambre-->
  <div class="modal fade col-xs-12 col-xs-offset-1" id="enregProduitConf">
     <div class="modal-dialog">
       <div class="modal-content">
       
         <div class="modal-header text-right">
            <a href="produits.php"><button type="button" class="btn btn-danger">x</button></a>
         </div>
         ...
         <div class="modal-body">
			   ...
			   <div class="panel panel-default">
				 ...
				 <div class="panel panel-body text-center">
					 ...
					 <h3>
					 <?php
					  if($_GET['newProduit']==0)
					  {echo '"'.$_GET['produit'].' '.$_GET['format'].' '.$_GET['dosage'].'" existe déja ! <br/> Aucun nouveau produit enregistré.';}
					  if($_GET['newProduit']==1)
					  {echo '"'.$_GET['produit'].' '.$_GET['format'].' '.$_GET['dosage'].'" <br/>a été enregistré avec succès !';}
                     ...
                     ?> 
					  ...
					  <div class="col-xs-12 text-center">
					   <a href="produits.php"><button type="button" class="btn btn-info">Fermer</button></a>
					  </div>
...
<input type="hidden"data-toggle="modal" href="#enregProduitConf" data-backdrop="false" id="btnEnregProduitConf" />
 
 
           <?php
			  if(isset($_GET['newProduit']))
			  {
				  
				  echo '<script type="text/javascript">
			  document.getElementById("btnEnregProduitConf").click();
			     </script>';
			  }
             ?>
             
             
<div class="modal fade col-xs-12 col-xs-offset-1" id="supprProduitConf">
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <div class="modal-body">
			   ...
			   <div class="panel panel-default">
				 ...
				 <div class="panel panel-body text-center">
					 ...
					 <h3>
					 <?php
					  if($_GET['supprProduit']==1)
					  {
					  echo '"'.$_GET['delProduit'].' '.$_GET['formatProduit'].' '.$_GET['dosageProduit'].'" a bien été supprimé.';
					  }
					  else
					  
					  {
					  echo 'Désolé il est impossible de supprimer "'.$_GET['delProduit'].' '.$_GET['formatProduit'].' '.$_GET['dosageProduit'].'".';
					  }
   ...
   <!--fin du modal de confirmation -->
<input type="hidden"data-toggle="modal" href="#supprProduitConf" data-backdrop="false" id="btnSupprProduitConf" />
           ...
           <?php
			  if(isset($_GET['supprProduit']))
			  {
				  ...
				  echo '<script type="text/javascript">
			  document.getElementById("btnSupprProduitConf").click();
			     </script>';
			  }
             ?>
