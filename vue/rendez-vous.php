...
<?php //sécurité contre l'accès à la page par l'url directement
 if ($_SESSION['clearance']==0 OR $_SESSION['clearance']==2) //les users avec un niveau 0 et 2 (infirmiers et externes) ne peuvent accéder aux rendez-vous 
 {
