<ul id="navigation" class="nav navbar-nav pull-right">
    <li<?php if ($nav_en_cours == 'acceuil') {echo ' id="en-cours"><a>Acceuil</a></li>';} else {echo '><a href="acceuil.php">Acceuil</a></li>';} ?>
    ...
    <li<?php if ($nav_en_cours == 'administration') {echo ' id="en-cours"><a>Administration</a></li>';} else {echo '><a href="administration.php">Administration</a></li>';} ?>
</ul>
