			   ...
			   <div class="panel panel-default">
				 ...
				 <div class="panel panel-body text-center">
					 ...
					 <h3>
						  ...
						  Êtes-vous sûr(e) de vouloir restaurer l\'utilisateur "'.$donnees['Nom'].' '.$donnees['Prenoms'].' né le '.dateFr($donnees['DateDeNaissance']).'" ? 
					  ...
					  <div class="col-xs-6 text-right">
					   <a href="../traitements/restaurerUtilisateurPost.php?idUtilisateur='.$donnees['Id'].'"><button type="submit" class="btn btn-success">Oui</button></a>
					  </div>
