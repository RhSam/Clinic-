 ...
 <ul  class="list-inline">
  ...
  <li class="child"><a href="consultationPatients.php">►Patients</a></li>
   ...
   <li class="grandchild" style="border:2px dotted rgba(204,255,255,1);
	border-radius:4px 4px 4px 4px;" id="current">»Consulter</li>
                ...
                <div class="panel panel-heading">
                  ...
                  <div class="entete">
                   ...
                   <div class="pull-right">
                      <button data-toggle="modal" href="#" data-backdrop="false" class="btn btn-default" style="margin-top:-4%;">
                      <a href="nouvelleConsultation.php?IdPatient=<?php echo $_GET['Per_Id'];?>">Nouvelle consultation</a>
                      </button>
                    </div>
                  
                 <hr />
                
                <form method="get" action="consultationUn.php"> 
                  <div class="col-xs-5"> 
...
<input type="hidden" class="btn btn-danger" data-toggle="modal" href="#confirmationExamen" data-backdrop="false" id="btnConfirmExamen" />
...
<input type="hidden" class="btn btn-danger" data-toggle="modal" href="#confirmationOrdon" data-backdrop="false" id="btnConfirmOrdon" />
