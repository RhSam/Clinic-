				  ...
				  echo '<tr>
						 ...
						 <td width="290">
						   <div class="btn-group">
						     ...
						     <a data-toggle="modal" href="#desactivation'.$donnees['Id'].'" data-backdrop="false" class="btn btn-default">Désactiver</a>
			   ...
			   <div class="panel panel-default">
				 ...
				 <div class="panel panel-body text-center">
				   ...
				   <form class="form">
					 ...
					 {
					   echo 'Ȇtes-vous sûr(e) de vouloir supprimer cet utilisateur ?
       ...
       <div class="modal-content">
         ...
         <div class="modal-body">
          ...
          <div class="col-xs-12 form-group">
           ...
           <input type="password" class="input-lg form-control" name="password" id="password" placeholder="mot de passe" autocomplete="on" required="required" spellcheck="false" maxlength="25"/>
