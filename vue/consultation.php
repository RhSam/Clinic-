...
<?php //sécurité contre l'accès à la page par l'url directement
 if ($_SESSION['clearance']<2) //les users avec un niveau inf à 3( secrétaires et externes) ne peuvent accéder à la consultation
 {
 ...
 <ul  class="list-inline">
   <li class="mother" style="border:2px dotted rgba(204,255,255,1);
	border-radius:4px 4px 4px 4px;" id="current">Consultation</li>
		  ...
		  $donnees2=$req2->fetch();
                          ...
                          echo '<tr>
                                 ...
                                 <td height="83">
                                    ...
                                    <button class="btn btn-default btn-sm btn-block"> <a href="constantes.php?Nom='.$donnees['Nom'].'&Prenoms='.$donnees['Prenoms'].'&Per_Id='.$donnees['Id'].'">Anciennes</a></button>
  ...
  <div class="modal fade col-xs-12 col-xs-offset-1" id="confEnregConst">
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <div class="modal-header text-right">
            <a href="consultation.php"><button type="button" class="btn btn-danger">x</button></a>
         </div>
...
<?php
 ...
 else //pour les médecins et administrateurs
 {
?> 
...
<div class="col-xs-2 bread">
 ...
 <ul  class="list-inline">
     <li class="mother" style="border:2px dotted rgba(204,255,255,1);
	border-radius:4px 4px 4px 4px;">Consultation</li>
 ...
 <div class="container col-xs-10 col-xs-push-2">
   ...
   <div class="col-xs-12 row row2">
     <div class="col-xs-5">
       ...
       <a href="consultationPatients.php"><img src="../ressources/images/icones/constantes.jpg" class="img-circle img-responsive" width="400" id="newPatient" alt="Consultations des patients" title="Consultations des patients"/></a>
       <br />
       <br />
       
       <a href="consultationPatients.php"><button class="btn btn-primary titreIcone" style="margin-left:2%;">Consultations des patients</button></a>
     </div><!--col-xs-6-1 -->
     
     
     
      <div class="col-xs-2" style="margin-top:25%;padding-left:2.2%">
        <a href="constantesTous.php"><img src="../ressources/images/icones/constantes2.jpg" class="img-circle img-responsive" width="120" id="Constantes" alt="Constantes" title="Constantes"/></a>
          <br />
          <div style="margin-top:8%;margin-left:9%;"><a href="constantesTous.php"><button class="btn btn-primary">Constantes</button></a></div>
       </div>
     ...
     <div class="col-xs-5">
       ...
       <a href="consultationTous.php"><img src="../ressources/images/icones/registreConsultations.jpg" class="img-circle img-responsive " width="400" id="oldPatient" alt="Registre des consultations" title="Registre des consultations"/></a>
       <br />
       <br />
       
       <a href="consultationTous.php"><button class="btn btn-primary titreIcone2" style="margin-left:2%;">Registre des consultations</button></a>
     </div><!--col-xs-6-2 -->
   </div><!--row 2 -->
 </div><!--container-->
