...
echo $_POST['nom'];
 ...
 $_POST['prenoms']=ucwords($_POST['prenoms']);
  header('location:../vue/modifierPatient.php?newPatient='.$newPatient.'&nom='.$_POST['nom'].'&prenoms='.$_POST['prenoms'].'&IdPatient='.$_POST['id'].'&dateDeNaissance='.$_POST['dateDeNaissance'].'&codePatient='.$codePatient);
?>
