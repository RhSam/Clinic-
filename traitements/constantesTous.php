                   ...
                   <tbody>
                     <?php  
                      ...
                      {      
                          ...
                          echo '<tr>
                                 <td height="62">'.$donnees['Nom'].'</td>
                                 <td height="62">'.$donnees['Prenoms'].'</td>
                                 <td height="62">'.Age($dateFr).'</td>
                                 <td height="62">-Dom: '.$donnees['TelephoneDomicile'].'</br>-Prof: '.$donnees['TelephoneProfessionnel'].'</td> 
								 <td height="62">'.$donnees['CodePatient'].'</td> 
                                 <td height="62" width="50%">
                                   
                                    <button data-toggle="modal" href="#constantes'.$donnees['Id'].'" data-backdrop="false" class="btn btn-primary btn-xs btn-block">Nouvelle prise</button>
									
                                    <button class="btn btn-default btn-xs btn-block"> <a href="constantes.php?Nom='.$donnees['Nom'].'&Prenoms='.$donnees['Prenoms'].'&Per_Id='.$donnees['Id'].'">Anciennes</a></button>
